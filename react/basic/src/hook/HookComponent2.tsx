...
export default function HookComponent2() {
    ...
    //useRef :
    // - DOM 객체를 직접 다루고자 할 때 혹은 랜더링 없이 값을 변경, 저장 하고 싶을 때 사용
    ...
    const onButtonClickHandler = () => {
        ...
        // 참조변수(null 혹은 undefined를 가질 수 있는 object 타입의 변수)에서 특정 속성 및 메서드를 호출하려 할 때 
        // null 혹은 undefined가 아닌 상태에서만 작업을 수행하도록 하려면 
        // 참조변수?.속성 혹은 참조변수?.함수()로 실행
